 ...
 */
public class SdVideoSmallSubscriptionOptions {
    ...
    public void setSdVideoSmallSubscriptionOptions(int videoId, String label, String url, String type, String sticky,
