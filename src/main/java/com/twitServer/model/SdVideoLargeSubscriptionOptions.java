 ...
 */
public class SdVideoLargeSubscriptionOptions {
    ...
    public void setSdVideoLargeSubscriptionOptions(int videoId, String label, String url, String type, String sticky,
